...
# tensorboard
writer = SummaryWriter("logs/mobile_light_train_log")
...
eval_loader, eval_sampler = get_eval_loader(None, Cityscapes, batch_size=1)
...
params_list = group_weight(params_list, model.spp,
                            BatchNorm2d, base_lr * 10)
params_list = group_weight(params_list, model.decoder,
                            BatchNorm2d, base_lr * 10)
params_list = group_weight(params_list, model.conv,
                            BatchNorm2d, base_lr * 10)
